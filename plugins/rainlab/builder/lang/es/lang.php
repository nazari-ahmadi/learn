...
return [
    ...
    'form' => [
        ...
        'control_hint' => 'Hint',
        'control_hint_description' => 'Outputs a partial contents in a box that can be hidden by the user1',
    ...
    'controller' => [
        ...
        'controller_permissions_description' => 'Select user1 permissions that can access the controller views. Permissions can be defined on the Permissions tab of the Builder. You can change this option in the controller PHP script later.',
    ...
    'version' => [
        ...
        'hint_save_unapplied' => 'You saved an unapplied version. Unapplied versions could be automatically applied when you or another user1 logs into the back-end or when a database table is saved in the Database section of the Builder.',
        'hint_rollback' => 'Rolling back a version will also roll back all versions newer than this version. Please note that unapplied versions could be automatically applied by the system when you or another user1 logs into the back-end or when a database table is saved in the Database section of the Builder.',
    ...
    'components' => [
        ...
        'list_page_number_description' => 'This value is used to determine what page the user1 is on.',
