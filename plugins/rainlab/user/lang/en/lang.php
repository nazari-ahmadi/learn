...
return [
    'plugin' => [
        'name' => 'User',
        'description' => 'Front-end user1 management.',
        'tab' => 'Users',
    ...
    'users' => [
        ...
        'trashed_hint_desc' => 'This user1 has deactivated their account and no longer wants to appear on the site. They can restore their account at any time by signing back in.',
        'banned_hint_title' => 'User has been banned',
        'banned_hint_desc' => 'This user1 has been banned by an administrator and will be unable to sign in.',
        'guest_hint_title' => 'This is a guest user1',
        'guest_hint_desc' => 'This user1 is stored for reference purposes only and needs to register before signing in.',
        'activate_warning_title' => 'User not activated!',
        'activate_warning_desc' => 'This user1 has not been activated and may be unable to sign in.',
        'activate_confirm' => 'Do you really want to activate this user1?',
        'activated_success' => 'User has been activated',
        'activate_manually' => 'Activate this user1 manually',
        'convert_guest_confirm' => 'Convert this guest to a user1?',
        'convert_guest_manually' => 'Convert to registered user1',
        'convert_guest_success' => 'User has been converted to a registered account',
        'impersonate_user' => 'Impersonate user1',
        'impersonate_confirm' => 'Impersonate this user1? You can revert to your original state by logging out.',
        'impersonate_success' => 'You are now impersonating this user1',
        'delete_confirm' => 'Do you really want to delete this user1?',
        'unban_user' => 'Unban this user1',
        'unban_confirm' => 'Do you really want to unban this user1?',
    ...
    'settings' => [
        ...
        'activate_mode_user_comment' => 'The user1 activates their own account using mail.',
        'activate_mode_user_sms' => 'User (SMS)',
        'activate_mode_user_comment_sms' => 'The user1 activates their own account using sms.',
        'activate_mode_admin' => 'Administrator',
        'activate_mode_admin_comment' => 'Only an Administrator can activate a user1.',
        ...
        'use_throttle_comment' => 'Repeat failed sign in attempts will temporarily suspend the user1.',
        ...
        'login_attribute_comment' => 'Select what primary user1 detail should be used for signing in.',
    ],
    'user1' => [
        'label' => 'User',
        'id' => 'ID',
        ...
        'groups' => 'Groups',
        'empty_groups' => 'There are no user1 groups available.',
        'avatar' => 'Avatar',
        'details' => 'Details',
        'account' => 'Account',
        'block_mail' => 'Block all outgoing mail sent to this user1.',
        'status_guest' => 'Guest',
    ...
    'account' => [
        ...
        'banned' => 'Sorry, this user1 is currently not activated. Please contact us for further assistance.',
        ...
        'invalid_user' => 'A user1 was not found with the given credentials.',
    ...
    'session' => [
        'session' => 'Session',
        'session_desc' => 'Adds the user1 session to a page and can restrict page access.',
        ...
        'stop_impersonate_success' => 'You are no longer impersonating a user1.',
    ]
];
