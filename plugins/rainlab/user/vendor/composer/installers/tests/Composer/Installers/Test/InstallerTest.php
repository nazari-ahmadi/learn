...
class InstallerTest extends TestCase
{
    ...
    public function dataForTestInstallPath()
    {
        return array(
            ...
            array('ee3-addon', 'system/user1/addons/ee_theme/', 'author/ee_theme'),
            array('ee3-theme', 'themes/user1/ee_package/', 'author/ee_package'),
            ...
            array('lithium-library', 'libraries/li3_test/', 'user1/li3_test'),
